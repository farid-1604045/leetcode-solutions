...
<pre style="position: relative;"><strong>Input:</strong> seats = [3,1,5], students = [2,7,4]
...
<pre style="position: relative;"><strong>Input:</strong> seats = [4,1,5,9], students = [1,3,2,6]
...
<pre style="position: relative;"><strong>Input:</strong> seats = [2,2,6,6], students = [1,3,2,6]
<strong>Output:</strong> 4
